...
<%
//    will check if the user that has login is currently available ie data is availlable in session or not
...
<!--        getting all the details of user who is login and showing it-->
